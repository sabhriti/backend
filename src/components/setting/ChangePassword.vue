...
export default {
    ...
    computed: {
        ...
        oldPassword: {
            ...
            set(value) {
                this.$store.commit('changePassword/UPDATE_OLD_PASSWORD', value)
            }
        },
        newPassword: {
            get() {
            ...
            set(value) {
                this.$store.commit('changePassword/UPDATE_NEW_PASSWORD', value)
            }
        },
        newPasswordRepeated: {
            get() {
            ...
            set(value) {
                this.$store.commit('changePassword/UPDATE_NEW_PASSWORD_REPEATED', value)
            }
        }
    }
}
